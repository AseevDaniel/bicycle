...
const FULL_LISTINGS: FullListing[] = [
  ...
  },
  {
    ...
    lng: -4.5157,
    sellerName: 'Pedro R.',
    sellerAvatar: 'https://i.pravatar.cc/80?img=6',
    sellerRating: 4.2,
    sellerReviews: 5,
    views: 76,
    favoritesCount: 9,
    ...
    isFeatured: false,
    description:
      'Solid trail hardtail, great for beginner and intermediate riders. Shimano Acera groupset, hydraulic disc brakes. Some scratches on the frame but mechanically sound. Helmet included.',
  },
  {
    id: '7',
    ...
    lng: -3.8713,
    sellerName: 'Sophie D.',
    sellerAvatar: 'https://i.pravatar.cc/80?img=7',
    sellerRating: 4.6,
    sellerReviews: 14,
    views: 98,
    favoritesCount: 14,
    ...
    isFeatured: false,
    description:
      'Lightweight aluminum road bike, ideal for coastal routes. Shimano 105 groupset, carbon fork. Serviced 2 months ago. Great condition apart from minor handlebar tape wear.',
  },
  {
    id: '8',
    ...
    isFeatured: true,
    description:
      'Premium e-road bike with virtually invisible motor integration. 250Wh internal battery, 85km assisted range. Carbon frame weighs just 12.3kg. Perfect for long coastal rides with a little extra help.',
  },
  {
    id: '9',
    ...
    lng: -4.0997,
    sellerName: 'Thomas H.',
    sellerAvatar: 'https://i.pravatar.cc/80?img=10',
    sellerRating: 4.4,
    sellerReviews: 9,
    views: 167,
    favoritesCount: 22,
    ...
    isFeatured: false,
    description:
      '125mm travel all-mountain bike. Fox suspension, SRAM NX Eagle 12-speed. Perfect for the trails around Axarquía. Rear brake pads recently replaced. Ready to ride.',
  },
  {
    id: '10',
    ...
    sellerAvatar: 'https://i.pravatar.cc/80?img=11',
    sellerRating: 5.0,
    sellerReviews: 27,
    views: 389,
    favoritesCount: 55,
    ...
    isFeatured: true,
    description:
      'Iconic Italian racing machine. Full carbon frame and fork, Campagnolo Chorus groupset. Purchased new from official dealer, only 800km. Includes original Bianchi accessories pack and receipt.',
  },
  {
    id: '11',
    ...
    isFeatured: false,
    description:
      'Workhorse commuter bike with hydraulic disc brakes. Used daily for 4 years, showing normal wear. New chain and cassette fitted last month. Great value for a reliable city bike.',
  },
  {
    id: '12',
    ...
    lng: -4.8825,
    sellerName: 'Chris P.',
    sellerAvatar: 'https://i.pravatar.cc/80?img=13',
    sellerRating: 4.8,
    sellerReviews: 22,
    views: 612,
    favoritesCount: 91,
    ...
    isFeatured: true,
    description:
      'Ultra-light e-bike that looks and feels like a regular road bike. 320Wh battery with up to 130km range in Eco mode. Barely 300km on the clock. Comes with EU road kit and spare battery.',
  },
  {
    id: '13',
    ...
    lng: -5.1467,
    sellerName: 'María J.',
    sellerAvatar: 'https://i.pravatar.cc/80?img=14',
    sellerRating: 4.1,
    sellerReviews: 4,
    views: 43,
    favoritesCount: 5,
    ...
    isFeatured: false,
    description:
      'Budget-friendly city bike in working order. Good for flat city riding. Brakes and gears recently adjusted. Some paint chips and surface rust on bolts but structurally sound.',
  },
  {
    id: '14',
    ...
    isFeatured: false,
    description:
      'Race-proven carbon frame with Shimano Dura-Ace groupset. ~3,000km total. Professional team rider setup. Minor scuff on top tube from a transport incident — cosmetic only. Fast bike for serious riders.',
  },
  {
    id: '15',
    ...
    lng: -4.4997,
    sellerName: 'Dave S.',
    sellerAvatar: 'https://i.pravatar.cc/80?img=16',
    sellerRating: 4.6,
    sellerReviews: 11,
    views: 134,
    favoritesCount: 20,
    ...
    isFeatured: false,
    description:
      'Capable gravel bike equally at home on tarmac and dirt. 700×45c tyres, Shimano Sora groupset, hydraulic disc brakes. Explored the Axarquía hills for one season. Clean and well maintained.',
  },
  {
    id: '16',
    ...
    lng: -3.8713,
    sellerName: 'Emma L.',
    sellerAvatar: 'https://i.pravatar.cc/80?img=17',
    sellerRating: 4.9,
    sellerReviews: 8,
    views: 87,
    favoritesCount: 12,
    ...
    isFeatured: false,
    description:
      'Perfect starter mountain bike for kids aged 8-12. Hydraulic disc brakes for safe stopping, 21-speed Shimano gearing. Lightly used for one summer, excellent condition.',
  },
  {
    id: '17',
    ...
    lng: -4.6381,
    sellerName: 'Pablo A.',
    sellerAvatar: 'https://i.pravatar.cc/80?img=18',
    sellerRating: 4.0,
    sellerReviews: 3,
    views: 62,
    favoritesCount: 8,
    ...
    isFeatured: false,
    description:
      'Dependable hardtail for trail riding. SR Suntour fork, Shimano Altus drivetrain. Shows its age but has been maintained. New tyres fitted this year. Great entry-level MTB for a fair price.',
  },
  {
    id: '18',
    ...
    lng: -4.0997,
    sellerName: 'Nina B.',
    sellerAvatar: 'https://i.pravatar.cc/80?img=19',
    sellerRating: 4.8,
    sellerReviews: 13,
    views: 234,
    favoritesCount: 33,
    ...
    isFeatured: true,
    description:
      'Family cargo bike capable of carrying two kids plus groceries. Bosch Performance Speed motor, 500Wh battery, hydraulic disc brakes. Barely 1,000km. Includes both Yepp Maxi child seats (€400 value).',
  },
  {
    id: '19',
    ...
    isFeatured: false,
    description:
      'Iconic British folding e-bike, perfect for mixed commutes. Folds in under 20 seconds, fits in luggage storage. 250W motor, up to 50km range. Light surface marks from daily use, mechanically perfect.',
  },
  {
    id: '20',
    ...
    lng: -4.6257,
    sellerName: 'Diego M.',
    sellerAvatar: 'https://i.pravatar.cc/80?img=21',
    sellerRating: 3.9,
    sellerReviews: 2,
    views: 38,
    favoritesCount: 4,
    ...
    isFeatured: false,
    description:
      'Entry-level street BMX, used and shows it. Pegs included, new grips fitted. Brakes work but lever has play. Good for a beginner who wants to learn tricks without worrying about scratches.',
  },
]
